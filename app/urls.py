...
from app.views.cart import product_cart, add_cart_view, delete_cart, edit_cart_item_view
...
from app.views.other import product_details_view, shop_view, add_product_view, edit_product, delete_product, \
    product_error404, product_compare_page, product_blog, product_blog_details_page, about_page, \
